...
**For users in China (ModelScope recommended):**
```bash
# Download via ModelScope (China network friendly)
...
- **Issue Reporting**: [GitHub Issues](https://github.com/RealBSMC/OpenNoteVisionLM/issues)
